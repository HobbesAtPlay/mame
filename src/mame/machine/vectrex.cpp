...
void vectrex_state::vectrex_configuration()
{
	...
	if (cport & 0x01) /* Imager enabled */
	{
		...
		{
		case 0x00:
			m_imager_colors[0] = m_imager_colors[1] = m_imager_colors[2] = RGB_T__BLACK;
			break;
		case 0x01:
		...
		{
		case 0x00:
			m_imager_colors[3] = m_imager_colors[4] = m_imager_colors[5] = RGB_T__BLACK;
			break;
		case 0x01:
	...
	else
	{
		...
		m_beam_color = RGB_T__WHITE;
		m_imager_colors[0] = m_imager_colors[1] = m_imager_colors[2] = m_imager_colors[3] = m_imager_colors[4] = m_imager_colors[5] = RGB_T__WHITE;
	}
