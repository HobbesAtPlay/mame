		...
		m_client_list(nullptr)
{
	...
	{
		m_entry_color[index] = RGB_T__BLACK;
	...
	{
		m_adjusted_color[index] = RGB_T__BLACK;
		m_adjusted_rgb15[index] = RGB_T__BLACK.as_rgb15();
	}

	// add black and white as the last two colors
	m_adjusted_color[numcolors * numgroups + 0] = RGB_T__BLACK;
	m_adjusted_rgb15[numcolors * numgroups + 0] = RGB_T__BLACK.as_rgb15();
	m_adjusted_color[numcolors * numgroups + 1] = RGB_T__WHITE;
	m_adjusted_rgb15[numcolors * numgroups + 1] = RGB_T__WHITE.as_rgb15();
}
